...
public class KpiAggregationService {
	...
	public KpiAggregationService(KpiRepository kpiRepository) {
		super();
		this.kpiRepository = kpiRepository;
	}

	/**
	 * Computes account-level utilization for the month of `asOf`. Utilization% =
	 * billable_hours / available_hours (across active engagement_resources)
	 */
	...
	/**
	 * Unbilled = Approved or Submitted hours in timesheet_snapshot where
	 * billing_snapshot has no matching amount (or zero) for the same (resource,
	 * engagement, month). This is a simplified KPI geared for Phase 14 expansion.
	 */
