...
//			@RequestParam(required = false) String clientId, @RequestParam(required = false) String engagementId,
//			@RequestParam(required = false) String roleId, @RequestParam(required = false) String location) {
...
//		var dto = kpiService.computeSummary(date);
...
//		LocalDate date = Optional.ofNullable(asOf).orElse(LocalDate.now());
//		var filter = new KpiFilter(clientId, engagementId, roleId, location);
//		var dto = kpiService.computeUtilization(date);
...
//		LocalDate date = Optional.ofNullable(asOf).orElse(LocalDate.now());
//		var filter = new KpiFilter(clientId, engagementId, roleId, location);
//		var dto = kpiService.computeUnbilled(date);
